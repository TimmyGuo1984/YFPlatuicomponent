...
var proForm = require('@ant-design/pro-form');
var mobxReactLite = require('mobx-react-lite');
var reactDnd = require('react-dnd');
var reactDndHtml5Backend = require('react-dnd-html5-backend');
var ProCard = require('@ant-design/pro-card');
var ProTable = require('@ant-design/pro-table');
var Draggable = require('react-draggable');
var Icons = require('@ant-design/icons/lib/icons');
var QRCode = require('qrcode.react');
var ReactToPrint = require('react-to-print');
var jsBase64 = require('js-base64');
var Avatar = require('antd/lib/avatar/avatar');
...
var ProCard__default = /*#__PURE__*/_interopDefaultLegacy(ProCard);
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return axios__default['default'].get(API, {
                params: params
              });
      ...
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return axios__default['default'].post(API, params, config);
      ...
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return axios__default['default'].put(API, params, config);
      ...
      return regeneratorRuntime.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return axios__default['default'].patch(API, params, config);
      ...
      return regeneratorRuntime.wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              _context6.next = 2;
              return axios__default['default'].delete(API, {
                data: params
              });
...
var setting = {};
var AppContext = /*#__PURE__*/React__default['default'].createContext(setting);
...
var UserStore = /*#__PURE__*/function () {
  function UserStore() {
    ...
    mobx.makeObservable(this, {
      ...
      isLogined: mobx.observable,
      setCurrentUser: mobx.action.bound,
      setLogined: mobx.action.bound
    });
  }
...
var headerRight = function headerRight() {
  ...
  var _useContext = React.useContext(AppContext$1),
  ...
  var personDropdown = /*#__PURE__*/React__default['default'].createElement(antd.Menu, {
    selectedKeys: [],
    onClick: function () {
    ...
    key: "chgpwd"
  }, /*#__PURE__*/React__default['default'].createElement(Icon.UserOutlined, null), "\u4FEE\u6539\u5BC6\u7801"), /*#__PURE__*/React__default['default'].createElement(antd.Menu.Divider, null), /*#__PURE__*/React__default['default'].createElement(antd.Menu.Item, {
    key: "logout"
  }, /*#__PURE__*/React__default['default'].createElement(Icon.LogoutOutlined, null), "\u9000\u51FA\u767B\u5F55"));
  return /*#__PURE__*/React__default['default'].createElement("p", {
    style: {
      float: 'right',
      marginRight: '24px'
    }
  }, /*#__PURE__*/React__default['default'].createElement(Icon.BellOutlined, {
    style: {
      color: '#fff',
      padding: '0'
    }
  ...
  }, /*#__PURE__*/React__default['default'].createElement(antd.Avatar, {
    size: "small",
    alt: "avatar",
    style: {
      marginRight: '12px'
    }
  }), mobxReactLite.useObserver(function () {
    ...
    return passChgModelVisible && /*#__PURE__*/React__default['default'].createElement(proForm.ModalForm, {
      width: 640,
      style: {
    ...
    }, /*#__PURE__*/React__default['default'].createElement(proForm.ProFormText.Password, {
      label: "\u65E7\u5BC6\u7801",
      name: "oldPass",
      rules: [{
        required: true
...
var HeaderRight = /*#__PURE__*/React__default['default'].memo(headerRight);
...
var mainHeader = function mainHeader() {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
  ...
  }, /*#__PURE__*/React__default['default'].createElement(Header, null, /*#__PURE__*/React__default['default'].createElement("p", {
    ...
    className: "Title"
  }, document.title)), /*#__PURE__*/React__default['default'].createElement(HeaderRight, null)));
};
...
var MenuStore = /*#__PURE__*/function () {
  ...
  function MenuStore() {
    ...
    this.activeTabKey = '';
    mobx.makeObservable(this, {
      allMenu: mobx.observable,
      tabs: mobx.observable,
      activeTabKey: mobx.observable,
      emptyTab: mobx.computed,
      currentTab: mobx.computed,
      setMenus: mobx.action.bound,
      changeTab: mobx.action.bound,
      addTab: mobx.action.bound,
      closeTab: mobx.action.bound,
      closeOtherTabs: mobx.action.bound,
      closeRightTabs: mobx.action.bound,
      onMoveTab: mobx.action.bound,
      closeAllTabMenu: mobx.action.bound
    });
    this.allMenu = [];
    this.tabs = [];
    this.activeTabKey = '';
...
var useInit = function useInit() {
  var _React$useContext = React__default['default'].useContext(AppContext),
...
var SubMenuList = mobxReactLite.observer(function () {
  ...
  var handleSubMEnu = function handleSubMEnu(menus) {
    return menus.map(function (item) {
      ...
      var iconElm = /*#__PURE__*/React__default['default'].createElement("div", null);

      if (CurIcon) {
        iconElm = /*#__PURE__*/React__default['default'].createElement(CurIcon, null);
      }
...
var SubMenuList$1 = /*#__PURE__*/React__default['default'].memo(SubMenuList);
...
var WrapTabNode = reactDnd.DropTarget('DND_NODE', cardTarget, function (connect) {
  return {
    connectDropTarget: connect.dropTarget()
  };
})(reactDnd.DragSource('DND_NODE', cardSource, function (connect, monitor) {
  return {
...
var DraggableTabs = function DraggableTabs(props) {
  ...
  var renderTabBar = function renderTabBar(props, DefaultTabBar) {
    return /*#__PURE__*/React__default['default'].createElement(DefaultTabBar, _objectSpread2({}, props), function (node) {
      return /*#__PURE__*/React__default['default'].createElement(WrapTabNode, {
        key: node.key,
        index: node.key,
        moveTabNode: moveTabNode
      }, /*#__PURE__*/React__default['default'].createElement("div", null, /*#__PURE__*/React__default['default'].createElement(antd.Dropdown, {
        ...
        }, /*#__PURE__*/React__default['default'].createElement("span", null, "\u5173\u95ED\u53F3\u4FA7\u6807\u7B7E\u9875")), /*#__PURE__*/React__default['default'].createElement(antd.Menu.Item, {
          disabled: closeOtherDisable(),
          onClick: function onClick() {
            onCloseOtherTabs(node.key);
          }
        }, /*#__PURE__*/React__default['default'].createElement("span", null, "\u5173\u95ED\u5176\u4ED6\u6807\u7B7E\u9875")), /*#__PURE__*/React__default['default'].createElement(antd.Menu.Item, {
          onClick: function onClick() {
            onCloseAllTabMenu(node.key);
          }
        }, /*#__PURE__*/React__default['default'].createElement("span", null, "\u5173\u95ED\u5168\u90E8\u6807\u7B7E\u9875"))),
        trigger: ['contextMenu']
      }, node)));
    });
  };
  ...
  }, /*#__PURE__*/React__default['default'].createElement(antd.Tabs, _objectSpread2({
    renderTabBar: renderTabBar
  }, otherProps), children));
};

var DraggableTabs$1 = /*#__PURE__*/React__default['default'].memo(DraggableTabs);
...
var tabList = mobxReactLite.observer(function () {
  var _React$useContext = React__default['default'].useContext(AppContext$2),
      pages = _React$useContext.pages,
      IndexPage = _React$useContext.IndexPage;

  var _React$useContext2 = React__default['default'].useContext(AppContext$2),
  ...
  var renderBanner = function renderBanner() {
    ...
    if (Array.isArray(banner)) {
      for (var index = 0; index < banner.length; index++) {
        ...
        ret.push( /*#__PURE__*/React__default['default'].createElement("img", {
          src: banner[index]
        }));
      }
    }
  ...
  if (!Array.isArray(tabs) || tabs.length === 0) {
    ...
    return /*#__PURE__*/React__default['default'].createElement(antd.Carousel, {
      effect: "fade",
      autoplay: true
    }, renderBanner());
  }
  ...
  return /*#__PURE__*/React__default['default'].createElement(DraggableTabs$1, {
    type: "editable-card",
    onChange: changeTab,
    ...
    var elm = /*#__PURE__*/React__default['default'].createElement(antd.Result, {
      icon: /*#__PURE__*/React__default['default'].createElement(Icon.BugFilled, null),
      title: "\u627E\u4E0D\u5230\u8BE5\u9875\u9762",
      subTitle: "urltype:".concat(urlType, " url:").concat(url, " \u5BF9\u5E94\u7684\u9875\u9762\u4E0D\u5B58\u5728\uFF0C\u8BF7\u8054\u7CFB\u5F00\u53D1\u4EBA\u5458"),
      extra: /*#__PURE__*/React__default['default'].createElement(antd.Button, {
        type: "primary",
        onClick: function onClick() {
          closeTab(id);
        }
    ...
    if (url && urlType) {
      switch (urlType) {
        case INTERNAL_MENU:
          ...
          if (Com) {
            elm = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Suspense, {
              fallback: /*#__PURE__*/React__default['default'].createElement(antd.Spin, {
                size: "large",
                tip: "\u6B63\u5728\u52A0\u8F7D\u4E2D..."
              })
            }, /*#__PURE__*/React__default['default'].createElement("div", {
              className: "TabContentFrame"
            }, /*#__PURE__*/React__default['default'].createElement(Com, _objectSpread2(_objectSpread2(_objectSpread2({}, props || {}), pars || {}), {}, {
        ...
        case EXTERNAL_MENU:
          //外部界面
          elm = /*#__PURE__*/React__default['default'].createElement("iframe", {
            title: id,
            className: "TabContentFrame",
            src: url,
            width: "100%",
...
var MainFrame = function MainFrame() {
  return /*#__PURE__*/React__default['default'].createElement(antd.Layout, null, /*#__PURE__*/React__default['default'].createElement(Sider, {
    width: 200,
    collapsible: true,
    collapsedWidth: 60,
    className: "SiteLayouBackground"
  }, /*#__PURE__*/React__default['default'].createElement(SubMenuList$1, null)), mobxReactLite.useObserver(function () {
    ...
    }, /*#__PURE__*/React__default['default'].createElement(tabList, null)), /*#__PURE__*/React__default['default'].createElement(Footer, {
      id: "MainFrameFooter"
...
var MainFrame$1 = /*#__PURE__*/React__default['default'].memo(MainFrame);
...
var basicLayout = function basicLayout() {
  ...
  }, /*#__PURE__*/React__default['default'].createElement(mainHeader, null), /*#__PURE__*/React__default['default'].createElement(MainFrame$1, null));
};

var Frame = /*#__PURE__*/React__default['default'].memo(basicLayout);
...
var App = function App(props) {
  ...
  React.useEffect(function () {
    ...
    if (skipOAuth || !userManager) {
      axios__default['default'].interceptors.request.use( /*#__PURE__*/function () {
      ...
      axios__default['default'].defaults.timeout = 60000;
      axios__default['default'].interceptors.request.use( /*#__PURE__*/function () {
  ...
  var Content = /*#__PURE__*/React__default['default'].createElement(reactRouterDom.BrowserRouter, null, /*#__PURE__*/React__default['default'].createElement(reactRouterDom.Switch, null, /*#__PURE__*/React__default['default'].createElement(reactRouterDom.Route, {
    exact: true,
  ...
  if (!useRouter) {
    Content = /*#__PURE__*/React__default['default'].createElement(Frame, null);
  }
...
var YiPlatLayout = /*#__PURE__*/React__default['default'].memo(App);
...
var SplitPage = function SplitPage(props) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(ProCard__default['default'], _objectSpread2({
    split: splitMode,
    style: style
  }, otherProps), /*#__PURE__*/React__default['default'].createElement(ProCard__default['default'], {
    colSpan: splitSpan,
    ghost: true
  }, subPage), mainPage && mainVisible && /*#__PURE__*/React__default['default'].createElement(ProCard__default['default'], {
    title: mainTitle
  }, !Array.isArray(mainPage) ? mainPage : /*#__PURE__*/React__default['default'].createElement(antd.Tabs, {
...
var MetaTable = function MetaTable(props) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(ProTable__default['default'], _objectSpread2({
    bordered: true,
    options: option,
    size: 'small',
    rowKey: 'id',
...
var CRUDTable = function CRUDTable(props) {
  ...
  var _useState5 = React.useState(dropMenus),
  ...
  React.useEffect(function () {
    ...
    var _handles = function _handles(record) {
      ...
      if (handleView) {
        ret.push( /*#__PURE__*/React__default['default'].createElement("a", {
          key: "handleView",
          onClick: function onClick() {
    ...
    if (typeof reqDels === 'function') {
      var del_handle = {
        ...
        handleClick: function handleClick(selectedRowKeys, action) {
          ...
          confirm({
            title: '确认删除此数据么?',
            icon: /*#__PURE__*/React__default['default'].createElement(Icon.ExclamationCircleOutlined, null),
            content: '删除数据后将无法恢复',
            okType: 'danger',
            okText: '是',
            cancelText: '否',
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      ...
                      case 2:
                        antd.message.success('删除成功，即将刷新');
                        setSelectedRowKeys([]);
  ...
  React.useEffect(function () {
    ...
    if (typeof handleAdd === 'function') {
      arr.push( /*#__PURE__*/React__default['default'].createElement(antd.Button, {
        key: "add",
        type: "primary",
        onClick: function onClick() {
          handleAdd();
        }
      }, /*#__PURE__*/React__default['default'].createElement(Icon.PlusOutlined, null), " \u65B0\u5EFA"));
    }
  ...
  var handleAlertRender = function handleAlertRender(props) {
    ...
    return /*#__PURE__*/React__default['default'].createElement(antd.Space, {
      size: 24
    }, /*#__PURE__*/React__default['default'].createElement("span", null, descr, /*#__PURE__*/React__default['default'].createElement("a", {
      style: {
        marginLeft: 8
      },
  ...
  var handleAlertOptionRender = function handleAlertOptionRender(_ref) {
    ...
    }, /*#__PURE__*/React__default['default'].createElement(antd.Button, null, "\u6279\u91CF\u64CD\u4F5C ", /*#__PURE__*/React__default['default'].createElement(Icon.DownOutlined, null)));
  };

  return /*#__PURE__*/React__default['default'].createElement(MetaTable, _objectSpread2(_objectSpread2({
    actionRef: actionRef,
...
var DraggableModal = function DraggableModal(props) {
  ...
  var cur_title = /*#__PURE__*/React__default['default'].createElement("div", {
    style: {
      width: '100%',
      cursor: 'move'
    },
...
var SimpleCRUDTable = function SimpleCRUDTable(props) {
  ...
  var tableRef = actionRef !== null && actionRef !== void 0 ? actionRef : React.useRef();
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              antd.message.error(result.message);
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(CRUDTable, _objectSpread2({
    actionRef: tableRef,
    columns: columns,
    handleAdd: _handleAdd,
    handleEdit: _handleEdit
  }, otherProps)), /*#__PURE__*/React__default['default'].createElement(DraggableModal, {
    forceRender: true,
    maskClosable: false,
    ...
    footer: null
  }, /*#__PURE__*/React__default['default'].createElement(ProTable__default['default'], {
    formRef: formRef,
...
var TreeTable = function TreeTable(props) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(SimpleCRUDTable, _objectSpread2({
    actionRef: actionRef,
    rowKey: curRowKey,
  ...
  return {
    filterDropdown: function filterDropdown(_ref) {
      ...
      return /*#__PURE__*/React__default['default'].createElement("div", {
        ...
        icon: /*#__PURE__*/React__default['default'].createElement(Icon.SearchOutlined, null),
        size: "small",
        style: {
          width: 90
        }
      }, "\u5E94\u7528"), /*#__PURE__*/React__default['default'].createElement(antd.Button, {
        onClick: function onClick() {
    ...
    filterIcon: function filterIcon(filtered) {
      return /*#__PURE__*/React__default['default'].createElement(Icon.SearchOutlined, {
        style: {
...
var TableSelect = function TableSelect(props) {
  ...
  }, /*#__PURE__*/React__default['default'].createElement(MetaTable, {
    rowKey: curPK,
    size: "small",
...
var TreeNode = antd.TreeSelect.TreeNode;
...
var IconSelect = function IconSelect(props) {
  ...
  React.useEffect(function () {
    var iconDic = Icons__namespace;
    var arr = [];
    var map = new Map(Object.entries(Icons__namespace));

    for (var key in iconDic) {
      var CurIcon = iconDic[key];
      arr.push( /*#__PURE__*/React__default['default'].createElement(Option$1, {
        key: key,
        value: key
      }, /*#__PURE__*/React__default['default'].createElement(CurIcon, null), key));
    }
...
var Ret = function Ret(props) {
  var _useContext = React.useContext(AppContext$3),
      apiBaseUrl = _useContext.apiBaseUrl;
  ...
  return /*#__PURE__*/React__default['default'].createElement(TreeModelSelect, _objectSpread2({
    onRequest: req
  }, props));
};
...
var Ret$1 = function Ret(props) {
  var _useContext = React.useContext(AppContext$4),
      apiBaseUrl = _useContext.apiBaseUrl;
  ...
  return /*#__PURE__*/React__default['default'].createElement(ModelSelect, _objectSpread2({
    mode: "multiple",
    showSearch: false,
    displayField: "name",
    allowClear: true,
...
var Ret$2 = function Ret(props) {
  var _useContext = React.useContext(AppContext$5),
      apiBaseUrl = _useContext.apiBaseUrl;
...
var Ret$3 = function Ret(props) {
  var _useContext = React.useContext(AppContext$6),
      apiBaseUrl = _useContext.apiBaseUrl;
...
var Ret$4 = function Ret(props) {
  var _useContext = React.useContext(AppContext$7),
      apiBaseUrl = _useContext.apiBaseUrl;
...
var Ret$5 = function Ret(props) {
  var _useContext = React.useContext(AppContext$8),
      apiBaseUrl = _useContext.apiBaseUrl;
...
var Ret$6 = function Ret(props) {
  var _React$useContext = React__default['default'].useContext(Contexts.AppContext),
      apiBaseUrl = _React$useContext.apiBaseUrl;

  return /*#__PURE__*/React__default['default'].createElement(TableSelect, _objectSpread2({
    columns: [{
      title: '编号',
      dataIndex: 'code',
      comparison: 'Contains'
...
var Ret$7 = function Ret(props) {
  var _useContext = React.useContext(AppContext$9),
      apiBaseUrl = _useContext.apiBaseUrl;
...
var Ret$8 = function Ret(props) {
  var _useContext = React.useContext(AppContext$a),
      apiBaseUrl = _useContext.apiBaseUrl;
...
var Ret$a = function Ret(props) {
  var _useContext = React.useContext(AppContext$b),
      apiBaseUrl = _useContext.apiBaseUrl;
...
var Ret$b = function Ret(_ref) {
  ...
  var _useContext = React.useContext(AppContext$c),
      apiBaseUrl = _useContext.apiBaseUrl;
...
var Ret$c = function Ret(props) {
  var _useContext = React.useContext(AppContext$d),
      apiBaseUrl = _useContext.apiBaseUrl;
...
var Ret$d = function Ret(props) {
  var _useContext = React.useContext(AppContext$e),
      apiBaseUrl = _useContext.apiBaseUrl;
...
var MetaTree = function MetaTree(props) {
  ...
  var _useState = React.useState(checkedKeys !== null && checkedKeys !== void 0 ? checkedKeys : []),
      _useState2 = _slicedToArray(_useState, 2),
      treeCheckedKeys = _useState2[0],
      setTreeCheckedKeys = _useState2[1];

  var _useState3 = React.useState(selectedKeys !== null && selectedKeys !== void 0 ? selectedKeys : []),
      _useState4 = _slicedToArray(_useState3, 2),
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, showToolbar && /*#__PURE__*/React__default['default'].createElement(antd.Space, {
    size: "small"
  }, refresh && /*#__PURE__*/React__default['default'].createElement(antd.Button, {
    shape: "circle",
    size: "small",
    onClick: function onClick() {
      handleRefresh();
    ...
    loading: loading,
    icon: /*#__PURE__*/React__default['default'].createElement(Icon.ReloadOutlined, null)
  }), all && /*#__PURE__*/React__default['default'].createElement(antd.Button // type="link"
  , {
    // type="link"
    shape: "round",
    size: "small",
  ...
  }, "\u5168\u9009"), clear && /*#__PURE__*/React__default['default'].createElement(antd.Button // type="link"
  , {
    // type="link"
    shape: "round",
    size: "small",
  ...
  }, "\u6E05\u7A7A"), total && /*#__PURE__*/React__default['default'].createElement("span", null, treeCheckedKeys && treeCheckedKeys.length > 0 ? "\u9009\u62E9\u4E86 ".concat(treeCheckedKeys.length, " \u9879") : "")), !loading && /*#__PURE__*/React__default['default'].createElement(antd.Tree, _objectSpread2({
    showLine: true,
    checkable: checkable,
...
var DownloadForm = function DownloadForm(props) {
  ...
  var _useContext = React.useContext(AppContext$f),
      apiBaseUrl = _useContext.apiBaseUrl;
  ...
  var renderContent = function renderContent() {
    ...
    return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(FormItem, {
      labelCol: {
        span: 5
      },
      wrapperCol: {
      ...
      label: "\u540D\u79F0"
    }, formVals.name), /*#__PURE__*/React__default['default'].createElement(FormItem, {
      labelCol: {
        span: 5
      },
      wrapperCol: {
      ...
      label: "\u63CF\u8FF0"
    }, formVals.description), /*#__PURE__*/React__default['default'].createElement(FormItem, {
      labelCol: {
        span: 5
      },
      wrapperCol: {
      ...
      label: "\u7C7B\u578B"
    }, formVals.fileType), /*#__PURE__*/React__default['default'].createElement(FormItem, {
      labelCol: {
        span: 5
      },
      wrapperCol: {
      ...
      label: "\u5927\u5C0F"
    }, getFileSize(formVals.fileSize)), /*#__PURE__*/React__default['default'].createElement(FormItem, {
      labelCol: {
        span: 5
      },
      wrapperCol: {
    ...
    }, /*#__PURE__*/React__default['default'].createElement(Icon.DownloadOutlined, null), "\u6587\u4EF6\u4E0B\u8F7D")), /*#__PURE__*/React__default['default'].createElement(FormItem, {
      labelCol: {
        span: 5
      },
      wrapperCol: {
  ...
  }, /*#__PURE__*/React__default['default'].createElement(antd.Form, _objectSpread2(_objectSpread2({}, formLayout), {}, {
    form: form,
...
var UploadForm = function UploadForm(props) {
  ...
  var _useState9 = React.useState(props.values || {}),
      _useState10 = _slicedToArray(_useState9, 2),
      vals = _useState10[0],
  ...
  var _useContext = React.useContext(AppContext$g),
      apiBaseUrl = _useContext.apiBaseUrl;
  ...
  var checkFile = function checkFile(file) {
    ...
    if (!isLtM) {
      antd.message.error('文件大小必须小于1000MB!');
    }
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              hide = antd.message.loading("\u6B63\u5728\u4E0A\u4F20", 0);
              _context2.prev = 2;
              _context2.next = 5;
            ...
            case 12:
              antd.message.warning("\u4E0A\u4F20\u5931\u8D25\uFF0C\u8BF7\u68C0\u67E5\u6570\u636E\u5E76\u91CD\u8BD5\uFF01");
              return _context2.abrupt("return", false);
  ...
  var renderContent = function renderContent() {
    return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(FormItem$1, {
      name: "folderId",
      labelCol: {
        span: 5
      },
    ...
    }, /*#__PURE__*/React__default['default'].createElement(FolderSelect, null)), /*#__PURE__*/React__default['default'].createElement(FormItem$1, {
      name: "name",
      labelCol: {
        span: 5
      },
      ...
      maxLength: 200,
      placeholder: "\u8BF7\u8F93\u5165\u6863\u6848\u540D\u79F0"
    })), /*#__PURE__*/React__default['default'].createElement(FormItem$1, {
      name: "description",
      labelCol: {
        span: 5
      },
      ...
      label: "\u4E0A\u4F20\u6587\u4EF6"
    }, /*#__PURE__*/React__default['default'].createElement(antd.Upload, {
      multiple: true,
      name: 'files',
    ...
    }, /*#__PURE__*/React__default['default'].createElement(antd.Button, null, /*#__PURE__*/React__default['default'].createElement(Icon.InboxOutlined, null), "\u9009\u62E9\u6587\u4EF6"))));
  };
  ...
  }, /*#__PURE__*/React__default['default'].createElement(antd.Form, _objectSpread2(_objectSpread2({}, formLayout$1), {}, {
    form: form,
    initialValues: formVals
  }), renderContent()));
};
...
var ModifyForm = function ModifyForm(props) {
  ...
  var _useState5 = React.useState(props.values || {}),
      _useState6 = _slicedToArray(_useState5, 2),
      vals = _useState6[0],
  ...
  var _useContext = React.useContext(AppContext$h),
      apiBaseUrl = _useContext.apiBaseUrl;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              hide = antd.message.loading("\u6B63\u5728\u4FEE\u6539", 0);
              _context2.prev = 2;
              _context2.next = 5;
            ...
            case 13:
              antd.message.warning("\u4FEE\u6539\u5931\u8D25\uFF0C\u8BF7\u68C0\u67E5\u6570\u636E\u5E76\u91CD\u8BD5\uFF01");
              return _context2.abrupt("return", false);
  ...
  var renderContent = function renderContent() {
    return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(FormItem$2, {
      name: "folderId",
      labelCol: {
        span: 5
      },
    ...
    }, /*#__PURE__*/React__default['default'].createElement(FolderSelect$1, null)), /*#__PURE__*/React__default['default'].createElement(FormItem$2, {
      name: "name",
      labelCol: {
        span: 5
      },
      ...
      maxLength: 200,
      placeholder: "\u8BF7\u8F93\u5165\u6863\u6848\u540D\u79F0"
    })), /*#__PURE__*/React__default['default'].createElement(FormItem$2, {
      name: "description",
      labelCol: {
        span: 5
      },
  ...
  }, /*#__PURE__*/React__default['default'].createElement(antd.Form, _objectSpread2(_objectSpread2({}, formLayout$2), {}, {
    form: form,
    initialValues: formVals
  }), renderContent()));
};
...
var FileCardListPage = function FileCardListPage(props) {
  var _useContext = React.useContext(AppContext$i),
      apiBaseUrl = _useContext.apiBaseUrl;
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(antd.PageHeader, {
    ghost: false,
    ...
    extra: [/*#__PURE__*/React__default['default'].createElement(antd.Button, {
      ...
      type: "primary",
      onClick: onBack
    }, "\u8FD4\u56DE\u5217\u8868"), /*#__PURE__*/React__default['default'].createElement(ReactToPrint__default['default'], {
      trigger: function trigger() {
        return /*#__PURE__*/React__default['default'].createElement("a", null, /*#__PURE__*/React__default['default'].createElement(antd.Button, {
          type: "primary"
        }, "\u6253\u5370\u4E8C\u7EF4\u7801"));
      },
      ...
      onAfterPrint: function onAfterPrint() {
        antd.message.info('打印成功！');
      }
    }), /*#__PURE__*/React__default['default'].createElement(antd.Button, {
      type: "text",
      shape: "circle",
      icon: /*#__PURE__*/React__default['default'].createElement(Icon.RedoOutlined, null),
      onClick: loadData,
      loading: loading
    })]
    ...
    renderItem: function renderItem(item) {
      return /*#__PURE__*/React__default['default'].createElement(antd.List.Item, null, /*#__PURE__*/React__default['default'].createElement(antd.Card, {
        style: {
          width: 160
        },
        cover: /*#__PURE__*/React__default['default'].createElement(QRCode__default['default'], {
...
var FileTablePage = function FileTablePage(props) {
  var _useContext = React.useContext(AppContext$j),
      apiBaseUrl = _useContext.apiBaseUrl;
  ...
  var cols = [{
    ...
    renderFormItem: function renderFormItem() {
      return /*#__PURE__*/React__default['default'].createElement(FolderSelect$2, null);
    },
  ...
  var deleteFile = function deleteFile(payload) {
    ...
    var hide = antd.message.loading("\u6B63\u5728\u5220\u9664", 0);
    ...
    try {
      ...
      if (result) {
        ...
        antd.message.warning("\u5220\u9664\u5931\u8D25\uFF0C\u8BF7\u68C0\u67E5\u6570\u636E\u5E76\u91CD\u8BD5\uFF01");
        return false;
      }
    } catch (error) {
      hide();
      antd.message.error("\u5220\u9664\u5931\u8D25\u8BF7\u91CD\u8BD5\uFF01");
      return false;
    }
  };
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, viewQrCode ? /*#__PURE__*/React__default['default'].createElement(FileCardListPage, {
    actionRef: actionRef,
    folderIds: folderIds,
    ...
    onBack: qrcode,
    toolbar: {
      actions: [/*#__PURE__*/React__default['default'].createElement(antd.Button, {
        key: "qrcode",
        type: "primary",
        onClick: qrcode
      }, "\u4E8C\u7EF4\u7801")]
    }
  }) : /*#__PURE__*/React__default['default'].createElement(CRUDTable, {
    actionRef: actionRef,
    search: false,
    columns: cols,
    defaultSort: {
    ...
    toolbar: {
      actions: [/*#__PURE__*/React__default['default'].createElement(antd.Button, {
        ...
        type: "primary",
        onClick: qrcode
      }, "\u4E8C\u7EF4\u7801"), /*#__PURE__*/React__default['default'].createElement(antd.Button, {
        key: "openUpload",
        type: "primary",
        onClick: openUpload
      }, "\u4E0A\u4F20\u6587\u4EF6")]
    ...
    handles: [allowModify && {
      ...
      onClick: function onClick(record) {
        ...
        var base64Url = jsBase64.Base64.encode(pullUrl);
        var pre = "".concat(previewUrl, "?url=").concat(encodeURIComponent(base64Url));
        window.open(pre);
      }
    }]
  }), uploadModalVisible ? /*#__PURE__*/React__default['default'].createElement(UploadForm, {
    onSubmit: function () {
  ...
  }) : null, modifyModalVisible && modifyFormValues && Object.keys(modifyFormValues).length ? /*#__PURE__*/React__default['default'].createElement(ModifyForm, {
  ...
  }) : null, viewModalVisible && viewFormValues && Object.keys(viewFormValues).length ? /*#__PURE__*/React__default['default'].createElement(DownloadForm, {
...
var FolderTree = function FolderTree(props) {
  ...
  var _useContext = React.useContext(AppContext$k),
      apiBaseUrl = _useContext.apiBaseUrl;
  ...
  var _useState3 = React.useState(false),
      ...
      loading = _useState4[0],
      setLoading = _useState4[1];
  return /*#__PURE__*/React__default['default'].createElement(ProCard__default['default'], null, /*#__PURE__*/React__default['default'].createElement(MetaTree, {
    keyField: "id",
    titleField: "name",
...
var PermissionPage = function PermissionPage(props) {
  ...
  var root = props.root,
      ...
      previewUrl = props.previewUrl,
      fileUrl = props.fileUrl;
  var subPage = /*#__PURE__*/React__default['default'].createElement(FolderTree, {
    root: root,
    auth: auth,
  ...
  var mainTitle = /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, folderIds && folderIds.map(function (id) {
    return /*#__PURE__*/React__default['default'].createElement(antd.Tag, null, id);
  }));
  var mainPage = /*#__PURE__*/React__default['default'].createElement(FileTablePage, {
    innerParams: folderIds,
    allowDownload: allowDownload,
    previewUrl: previewUrl,
    fileUrl: fileUrl
  });
  return /*#__PURE__*/React__default['default'].createElement(SplitPage, {
    style: {
      height: '100%'
    },
    subPage: subPage,
...
var FolderPage = function FolderPage(props) {
  var _useContext = React.useContext(AppContext$l),
      apiBaseUrl = _useContext.apiBaseUrl;
  ...
  var cols = [{
    ...
    hideInTable: true,
    renderFormItem: function renderFormItem() {
      return /*#__PURE__*/React__default['default'].createElement(FolderSelect$3, null);
    }
  }, {
    title: '名称',
    dataIndex: 'name',
  ...
  return /*#__PURE__*/React__default['default'].createElement(TreeTable, {
    search: false,
    columns: cols,
    reqQuery: function reqQuery(params) {
      var pageSize = params.pageSize,
...
var PersonPage = function PersonPage(props) {
  var _useContext = React.useContext(AppContext$m),
      apiBaseUrl = _useContext.apiBaseUrl;
  ...
  var cols = [{
    ...
    renderFormItem: function renderFormItem() {
      return /*#__PURE__*/React__default['default'].createElement(OrgSelect, null);
    }
  }, {
    title: '描述',
    dataIndex: 'description',
  ...
  return /*#__PURE__*/React__default['default'].createElement(SimpleCRUDTable, {
    columns: cols,
    defaultSort: {
      'Org.TreeIndex': true,
      Code: true
...
var UdcPage = function UdcPage(props) {
  ...
  var _useContext = React.useContext(AppContext$n),
      apiBaseUrl = _useContext.apiBaseUrl;
  ...
  var cols = [{
    ...
    renderFormItem: function renderFormItem() {
      return /*#__PURE__*/React__default['default'].createElement(PersonSelect, null);
    }
  }, {
    title: '人员所属组织',
...
var ApiLogPage = function ApiLogPage(props) {
  var _useContext = React.useContext(AppContext$o),
      apiBaseUrl = _useContext.apiBaseUrl;
  ...
  return /*#__PURE__*/React__default['default'].createElement(MetaTable, {
    columns: columns,
...
var MenuPage = function MenuPage(props) {
  var _useContext = React.useContext(AppContext$p),
      apiBaseUrl = _useContext.apiBaseUrl;
  ...
  var cols = [{
    ...
    hideInTable: true,
    renderFormItem: function renderFormItem() {
      return /*#__PURE__*/React__default['default'].createElement(MenuSelect, null);
    }
  }, {
    title: '标题',
    dataIndex: 'name',
    ...
    render: function render(text) {
      ...
      if (CurIcon) {
        return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(CurIcon, null), text);
      }

      return text;
    },
    renderFormItem: function renderFormItem() {
      return /*#__PURE__*/React__default['default'].createElement(IconSelect, null);
    }
  }, {
    title: '附加参数',
    dataIndex: 'params',
...
var TenantClaimPage = function TenantClaimPage(props) {
  ...
  var _useContext = React.useContext(AppContext$q),
      apiBaseUrl = _useContext.apiBaseUrl;
  ...
  return /*#__PURE__*/React__default['default'].createElement(SimpleCRUDTable, {
    ...
    extraToolBarButtons: [/*#__PURE__*/React__default['default'].createElement(antd.Button, {
      onClick: function () {
...
var OrgPage = function OrgPage(props) {
  var _useContext = React.useContext(AppContext$r),
      apiBaseUrl = _useContext.apiBaseUrl;
  ...
  var cols = [{
    ...
    hideInTable: true,
    renderFormItem: function renderFormItem() {
      return /*#__PURE__*/React__default['default'].createElement(OrgSelect$1, null);
    }
  }, {
    title: '组织编号',
    dataIndex: 'code',
    ...
    renderFormItem: function renderFormItem() {
      return /*#__PURE__*/React__default['default'].createElement(OrgTypeSelect, null);
    }
  }, {
    title: '顺序',
    dataIndex: 'treeIndex',
...
var OrgTypePage = function OrgTypePage(props) {
  var _useContext = React.useContext(AppContext$s),
      apiBaseUrl = _useContext.apiBaseUrl;
...
var TenantClaimPage$1 = function TenantClaimPage(props) {
  ...
  var _useContext = React.useContext(AppContext$t),
      apiBaseUrl = _useContext.apiBaseUrl;
...
var _beforeUpload = function beforeUpload(file) {
  ...
  if (KBNum < 10) {
    antd.message.error('照片不能低于10kb!');
    return false;
  }

  if (KBNum > 200) {
    antd.message.error('照片不能超过200kb!');
    return false;
  }
...
var AvatarUpload = function AvatarUpload(props) {
  var _useContext = React.useContext(AppContext$u),
      apiBaseUrl = _useContext.apiBaseUrl;
  ...
  React.useEffect(function () {
    if (value) {
      axios__default['default'].get("".concat(apiBaseUrl, "/avatar/").concat(value, "/Base64")).then(function (base64Str) {
  ...
  }) : /*#__PURE__*/React__default['default'].createElement(Icon.PlusOutlined, null));
};
...
var PersonPage$1 = function PersonPage(props) {
  ...
  var _useContext = React.useContext(AppContext$v),
      apiBaseUrl = _useContext.apiBaseUrl;
  ...
  var cols = [{
    ...
    renderFormItem: function renderFormItem() {
      return /*#__PURE__*/React__default['default'].createElement(OrgSelect$2, null);
    }
  }, {
    title: '岗位',
    dataIndex: 'jobIds',
    ...
    render: function render(text, record) {
      ...
      return record === null || record === void 0 ? void 0 : (_record$jobs = record.jobs) === null || _record$jobs === void 0 ? void 0 : _record$jobs.map(function (v) {
        return /*#__PURE__*/React__default['default'].createElement(antd.Tag, null, v.name);
      });
    },
    renderFormItem: function renderFormItem() {
      return /*#__PURE__*/React__default['default'].createElement(JobSelect, null);
    }
  }, {
    title: '性别',
    dataIndex: 'gender',
    ...
    render: function render(text, record) {
      ...
      return isActive ? /*#__PURE__*/React__default['default'].createElement(antd.Tag, {
        color: "success"
      }, "\u542F\u7528") : /*#__PURE__*/React__default['default'].createElement(antd.Tag, {
        color: "error"
      }, "\u7981\u7528");
    }
  }, {
    ...
    render: function render(text, record, index) {
      ...
      if (avatarId) {
        ...
        var img = /*#__PURE__*/React__default['default'].createElement(antd.Image, {
          src: url
        });
      ...
      return /*#__PURE__*/React__default['default'].createElement(antd.Avatar, {
        icon: /*#__PURE__*/React__default['default'].createElement(Icon.UserOutlined, null)
      });
    },
    renderFormItem: function renderFormItem(schema, config, form) {
      return /*#__PURE__*/React__default['default'].createElement(AvatarUpload, null);
    }
  }, {
    title: '创建时间',
    dataIndex: 'createTime',
  ...
  return /*#__PURE__*/React__default['default'].createElement(antd.Row, null, /*#__PURE__*/React__default['default'].createElement(antd.Col, {
    span: 6
  }, /*#__PURE__*/React__default['default'].createElement(MetaTree, {
    keyField: "id",
    titleField: "name",
    ...
    span: 18
  }, /*#__PURE__*/React__default['default'].createElement(SimpleCRUDTable, {
    columns: cols,
    defaultSort: {
      code: true
    },
...
var RoleTable = function RoleTable(props) {
  ...
  var _useContext = React.useContext(AppContext$w),
      apiBaseUrl = _useContext.apiBaseUrl;
  ...
  return /*#__PURE__*/React__default['default'].createElement(MetaTable, _objectSpread2({
    columns: columns,
    request: function request(params, sorter, filter) {
      var _roleName$trim;
...
var TreePermission = function TreePermission(props) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(antd.Spin, {
  ...
  }, checkedKeys && checkedKeys.length > 0 ? "\u9009\u62E9\u4E86 ".concat(checkedKeys.length, " \u9879") : "\u672A\u9009\u62E9", /*#__PURE__*/React__default['default'].createElement(antd.Button, {
    type: "link",
    onClick: handleClear
  }, "\u6E05\u7A7A\u9009\u62E9")), /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    ghost: true,
    onClick: handleSave
  }, "\u4FDD\u5B58"))), /*#__PURE__*/React__default['default'].createElement(MetaTree, _objectSpread2({
    keyField: keyField,
...
var PermissionPage$1 = function PermissionPage(props) {
  ...
  var _useContext = React.useContext(Contexts.AppContext),
      apiBaseUrl = _useContext.apiBaseUrl,
  ...
  var _props$authAccess = props.authAccess,
      authAccess = _props$authAccess === void 0 ? false : _props$authAccess;
  var subPage = /*#__PURE__*/React__default['default'].createElement(RoleTable, {
    onChange: function onChange(r) {
  ...
  var mainPages = [{
    key: 'menu',
    tab: '菜单授权',
    page: /*#__PURE__*/React__default['default'].createElement(TreePermission, {
      innerParams: role,
...
var TenantClaimPage$2 = function TenantClaimPage(props) {
  ...
  var _useContext = React.useContext(AppContext$x),
      apiBaseUrl = _useContext.apiBaseUrl;
...
var TenantPage = function TenantPage(props) {
  var _useContext = React.useContext(AppContext$y),
      apiBaseUrl = _useContext.apiBaseUrl;
...
var TenantRolePage = function TenantRolePage(props) {
  ...
  var _useContext = React.useContext(AppContext$z),
      apiBaseUrl = _useContext.apiBaseUrl;
  ...
  var cols = [{
    ...
    renderFormItem: function renderFormItem() {
      return /*#__PURE__*/React__default['default'].createElement(RoleTableSelect, null);
    }
  }, {
    title: '角色名称',
    dataIndex: 'roleName',
...
var Ret$e = function Ret(props) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(TableSelect, _objectSpread2({
    columns: [{
      ...
      renderFormItem: function renderFormItem() {
        return /*#__PURE__*/React__default['default'].createElement(Ret$d, null);
      }
    }],
    reqQuery: function () {
      var _reqQuery = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(params) {
...
var UdcPage$1 = function UdcPage(props) {
  ...
  var cols = [{
    ...
    renderFormItem: function renderFormItem() {
      return /*#__PURE__*/React__default['default'].createElement(Ret$e, null);
    }
  }, {
    title: '自定义名称',
...
var UdcPage$2 = function UdcPage(props) {
  ...
  var uploadProps = {
    ...
    onChange: function onChange(info) {
      ...
      if (info.file.status === 'done') {
        antd.message.success("".concat(info.file.name, " \u5BFC\u5165\u6210\u529F\uFF01"));
      } else if (info.file.status === 'error') {
        antd.message.error("".concat(info.file.name, " \u5BFC\u5165\u5931\u8D25\uFF01"));
      }
  ...
  return /*#__PURE__*/React__default['default'].createElement(SimpleCRUDTable, {
    ...
    extraToolBarButtons: [/*#__PURE__*/React__default['default'].createElement(antd.Upload, _objectSpread2({}, uploadProps), /*#__PURE__*/React__default['default'].createElement(antd.Button, {
      icon: /*#__PURE__*/React__default['default'].createElement(Icon.ImportOutlined, null)
    }, "\u6279\u91CF\u5BFC\u5165")), /*#__PURE__*/React__default['default'].createElement(antd.Button, {
      icon: /*#__PURE__*/React__default['default'].createElement(Icon.FileExcelFilled, null),
      onClick: function onClick() {
...
var UdcTypePage = function UdcTypePage(props) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(SimpleCRUDTable, {
    ...
    extraToolBarButtons: [/*#__PURE__*/React__default['default'].createElement(antd.Upload, _objectSpread2({}, uploadProps), /*#__PURE__*/React__default['default'].createElement(antd.Button, {
      icon: /*#__PURE__*/React__default['default'].createElement(Icon.ImportOutlined, null)
    }, "\u4ECE\u5C5E\u5173\u7CFB\u5BFC\u5165")), /*#__PURE__*/React__default['default'].createElement(antd.Button, {
      icon: /*#__PURE__*/React__default['default'].createElement(Icon.DownloadOutlined, null),
      onClick: function onClick() {
...
var PassresetForm = function PassresetForm(props) {
  ...
  var _useState3 = React.useState(props.values || {}),
      _useState4 = _slicedToArray(_useState3, 2),
  ...
  var renderContent = function renderContent() {
    return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(FormItem$3, {
      name: "userName",
      labelCol: {
        span: 5
      },
      ...
      readOnly: true,
      bordered: false
    })), /*#__PURE__*/React__default['default'].createElement(FormItem$3, {
      name: "personName",
      labelCol: {
        span: 5
      },
  ...
  var renderFooter = function renderFooter() {
    ...
    }, "\u786E\u8BA4"), /*#__PURE__*/React__default['default'].createElement(antd.Button, {
      onClick: function onClick() {
  ...
  }, /*#__PURE__*/React__default['default'].createElement(antd.Form, _objectSpread2(_objectSpread2({}, formLayout$3), {}, {
    form: form,
    initialValues: formVals
  }), renderContent()));
};
...
var UserPage = function UserPage(props) {
  ...
  var cols = [{
    ...
    render: function render(text, record) {
      ...
      return isTenantAdmin ? /*#__PURE__*/React__default['default'].createElement(antd.Tag, {
        color: "success"
      }, "\u542F\u7528") : /*#__PURE__*/React__default['default'].createElement(antd.Tag, {
        color: "error"
      }, "\u7981\u7528");
    ...
    renderFormItem: function renderFormItem() {
      return /*#__PURE__*/React__default['default'].createElement(TenantAccessSelect, null);
    }
  }, {
    title: '授权租户',
    ...
    render: function render(text, record) {
      ...
      return record === null || record === void 0 ? void 0 : (_record$tenantAccess = record.tenantAccess) === null || _record$tenantAccess === void 0 ? void 0 : _record$tenantAccess.map(function (v) {
        return /*#__PURE__*/React__default['default'].createElement(antd.Tag, null, v.tenantName);
      });
    },
    renderFormItem: function renderFormItem() {
      return /*#__PURE__*/React__default['default'].createElement(TenantAccessSelect, {
        mode: "multiple"
      });
    }
  }, {
    ...
    render: function render(text, record) {
      ...
      return record === null || record === void 0 ? void 0 : (_record$roles = record.roles) === null || _record$roles === void 0 ? void 0 : _record$roles.map(function (v) {
        return /*#__PURE__*/React__default['default'].createElement(antd.Tag, null, v.roleName);
      });
    },
    renderFormItem: function renderFormItem() {
      return /*#__PURE__*/React__default['default'].createElement(RoleAccessSelect, {
        mode: "multiple"
      });
    }
  }, {
    ...
    hideInTable: true,
    renderFormItem: function renderFormItem() {
      return /*#__PURE__*/React__default['default'].createElement(PersonSelect$1, null);
    }
  }, {
    title: '身份证号',
    dataIndex: 'idNumber',
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(SimpleCRUDTable, {
    columns: cols,
    defaultSort: {
      UserName: true
    },
  ...
  }), passresetVisible ? /*#__PURE__*/React__default['default'].createElement(PassresetForm, {
    onSubmit: function () {
...
exports.Tree = index$4;
exports.YiPlatLayout = YiPlatLayout;
